    ...
    <nav className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${scrolled ? "bg-white/95 backdrop-blur-md shadow-sm border-b border-avg-blue/10" : "bg-transparent"}`}>
      <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
        <div className="flex items-center gap-3">
          <div className="w-8 h-8 geo-diagonal rounded flex items-center justify-center">
            <span className="text-white font-cormorant font-bold text-sm">A</span>
          </div>
  ...
  return (
    <footer className="bg-avg-dark py-10">
      <div className="max-w-7xl mx-auto px-6 flex flex-col md:flex-row items-center justify-between gap-4">
        <div className="flex items-center gap-3">
          <div className="w-7 h-7 geo-diagonal rounded flex items-center justify-center">
            <span className="text-white font-cormorant font-bold text-xs">A</span>
          </div>
