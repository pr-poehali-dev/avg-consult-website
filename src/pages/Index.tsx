...
const SERVICES = [
  { icon: "Briefcase", title: "Корпоративное право", desc: "Сопровождение корпоративных споров, сопряженных с трудовым правом." },
  ...
  { icon: "ClipboardCheck", title: "Кадровый аудит", desc: "Проведение кадрового аудита с учетом требований ГИТ. Помощь в устранении недостатков." },
  { icon: "Shield", title: "Защита бизнеса", desc: "Оказание юридических услуг и правового сопровождения по текущим вопросам." },
